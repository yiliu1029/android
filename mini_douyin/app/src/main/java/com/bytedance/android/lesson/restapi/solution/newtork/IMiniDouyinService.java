...
public interface IMiniDouyinService {
    // -C2 (7) Implement your MiniDouyin PostVideo Request here,
    @Multipart
    @POST("mini_douyin/invoke/video?student_id={4}&user_name={4}")
    ...
    // -C2 (8) Implement your MiniDouyin Feed Request here, url: (GET) http://test.androidcamp.bytedance.com/mini_douyin/invoke/video
